...
public class CropImageView extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mBitmap != null) {
            ...
            final Rect bitmapRect = ImageViewUtil.calculateFitCenterObjectRect(mBitmap.getWidth(),
                                                                            mBitmap.getHeight(),
                                                                            mLayoutWidth,
                                                                            mLayoutHeight);
            mCropOverlayView.setBitmapRect(bitmapRect);
     ...
     * Sets the cut resource graph
     * 
     * @param bitmap
     * Cut the resource graph
     * 
     */
   ...
   */
     ...
     * 
     * false: Free cutting
     * true : Fixed size proportional shear
     * 
     ...
     * Sets the scale of the fixed scale cut
     * 现将setFixedAspectRatio(true)设置
     * 
     * 例如：cropImage.setAspectRatio(40, 30);是以40:30Of the width and height of the cut
     * 
     * @param 
    ...
    public void reverseImage(CropImageType.REVERSE_TYPE type)
    {
    	...
    	{
    		matrix.postScale(1, -1);//up : down
    	}
    	else if(type == CropImageType.REVERSE_TYPE.LEFT_RIGHT)
    	{
    		matrix.postScale(-1, 1);;//right : left
    	}
    ...
    /**
     * Change the style of the four corners of the cut box
     * 
     * @param bit
     * Style image
     * Bit = null, the default is a white corner edge
     * 
     */
    ...
    public void setOverlayViewEnable(boolean flg) {
        mCropOverlayView.setEnabled(flg);
    }
